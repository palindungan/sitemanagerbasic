 ...
 */
class member2 extends testBase
{
    /**
    ...
    function index()
    {
        ...
        $this->say("<a href='member2.php?form=create'>Create</a><br>");
        ...
        while ($item = $query->fetch()) {
            $htmlTableRow .= '
                <tr>
                    ...
                    <td>
                        <a href="member2.php?form=edit&id=' . $item['idxNum'] . '">Ubah</a>
                        <a href="member2.php?action=destroy&id=' . $item['idxNum'] . '">Delete</a>
                    </td>
                </tr>
            ';
        }
    ...
    function create()
    {
        ...
        $myForm->directive['postScript'] = 'member2.php?form=create&action=store';
    ...
    function edit()
    {
        ...
        $myForm->directive['formAttributes'] = 'role="form" enctype="multipart/form-data"';
        $myForm->directive['postScript'] = 'member2.php?form=edit&id=' . $this->getVar('id') . '&action=update';
        $myForm->runForm(); // apply the form
